...
def main(argv):
    ...
    parser.add_argument('--am1', dest='at_memory1', type=int, default=16)
    parser.add_argument('--am2', dest='at_memory2', type=int, default=16)
    parser.add_argument('--rm1', dest='rule_memory1', type=int, default=16)
    parser.add_argument('--rm2', dest='rule_memory2', type=int, default=16)
    parser.add_argument('--nm1', dest='network_memory1', type=int, default=16)
    parser.add_argument('--nm2', dest='network_memory2', type=int, default=16)
